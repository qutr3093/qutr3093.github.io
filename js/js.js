  ...
  var spark = new Audio("http://k003.kiwi6.com/hotlink/qdpr7bioht/spark.mp3");
 	...
 	function countdown() {
 		...
 		var timer = setInterval(function(){
    		...
    		if (seconds === 0) {
    			alert("Congrats! Your score is " + points);
    			scoreBox.innerHTML = "0";
    			words.innerHTML = "";
    			button.disabled = false;
    			clearInterval(timer);
    			seconds = 30;
    			timerBox.innerHTML = "30";
    			button.disabled = false;	
    		}
 		}, 1000);
  	}
  	...
  	const list = ['ANIMAL','ANNOUNCED','ANOTHER','ANSWER','ANTS','ANY','ANYBODY','ANYONE',
  ...
  'DIRECTLY','DIRT','DIRTY','DISAPPEAR','DISCOVER','DISCOVERY',
